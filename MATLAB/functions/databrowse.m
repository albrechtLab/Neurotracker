...
if ~exist('h')
    ...
    % indexed values must be < the total # of values in a's 1-dim
        % updated: 2023-01-24 by VLK
    if (numel(1:sep:255) > size(a,1))
        sep = ceil(254/(ng-1));
    end
    
    % without line 179, line 184 below returns errors often
